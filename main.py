...
from dictionary import MyDictionary #import the dictionary
...
dic = MyDictionary() #get the dictionary data
...
def init(): #initialize the app
    ...
    root.title('仔仔的中英字典') #give the window a title
